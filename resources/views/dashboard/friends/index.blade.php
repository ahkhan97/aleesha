                            ...
                            <table class="table table-hover table-order">
                                ...
                                @foreach($friends as $request)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{asset($request->showfriends->img_tab->img_path)}}"  width="70px" height="70px" alt="">
                                        </td>
                                        <td style="padding-top:40px;">{{$request->showfriends->name}} {{$request->showfriends->lname}}</td>
                            
                                        <td style="padding-top:40px;">
                                      
                                      
                                        
                                            <a href="javascript:void(0)" class="alert alert-success accept" data-id="{{ $request->user_id }}">Chat</a>
